% Load your stereo parameters and rectification data
load('stereoParams.mat'); % Example stereo parameters
...
% Define the name of the output video file
videoFilename = '3d_reconstruction_video.avi';
